...
def homepage(request):
    ...
    if totalTest < 1:
        ...
        questions = models.Question.objects.filter(level = "easy").exclude(topic = "Differential Equations").exclude(topic = "Three Dimensional Geometry").exclude(topic = "Linear Programming").exclude(topic = "Integrals")
    else:
        questions = models.Question.objects.all().exclude(topic = "Differential Equations").exclude(topic = "Three Dimensional Geometry").exclude(topic = "Linear Programming").exclude(topic = "Integrals")
